...
2. **Analyse avancée et transformations**  ----> Myriam à compléter
   - Préparation des données  
   - Encodage des variables catégorielles  
   - Analyse des corrélations et PCA  

3. **Modélisation et conclusions**  ------> Ines et Lina à copléter
...
```bash
git clone https://github.com/myriamaitsaid/HACKATON_IBM_19.git
cd HACKATON_IBM_19
